...
def get_git_commit_sha():
    try:
        ...
        return "Could not retrieve commit SHA"
...
experiment_name = "Maternal_Health_Risk_Prediction"
    ...
    if not validation_errors:
        ...
        try:
            with mlflow.start_run():
                ...
                mlflow.log_param('systolic_bp', systolic_bp)
                mlflow.log_param('bs', bs)
                mlflow.log_param('body_temp', body_temp)
                ...
                # Log the prediction
                mlflow.log_metric('predicted_risk_level', prediction[0])
